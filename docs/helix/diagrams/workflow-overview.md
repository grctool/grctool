...
graph TB
    subgraph "HELIX Development Spiral"
        ...
        D[2. DESIGN<br/>Architecture & Solutions]
        T[3. TEST<br/>Write Failing Tests]
        B[4. BUILD<br/>Implement to Pass Tests]
...
graph LR
    subgraph "Phase Progression with Quality Gates"
        ...
        IG1 -->|Pass| Frame[1. FRAME]
        Frame --> EG1{Exit<br/>Gate}
        EG1 -->|Pass| IG2{Input<br/>Gate}
        IG2 -->|Pass| Design[2. DESIGN]
        Design --> EG2{Exit<br/>Gate}
        EG2 -->|Pass| IG3{Input<br/>Gate}
        IG3 -->|Pass| Test[3. TEST]
        Test --> EG3{Exit<br/>Gate}
        EG3 -->|Pass| IG4{Input<br/>Gate}
        IG4 -->|Pass| Build[4. BUILD]
        Build --> EG4{Exit<br/>Gate}
        EG4 -->|Pass| IG5{Input<br/>Gate}
        IG5 -->|Pass| Deploy[5. DEPLOY]
        Deploy --> EG5{Exit<br/>Gate}
        EG5 -->|Pass| Iterate[6. ITERATE]
