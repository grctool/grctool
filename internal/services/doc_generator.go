...
// GenerateAgentDocs generates all agent documentation files
// These are reference documents for AI agents to consult during autonomous operation
...
func generateEvidenceWorkflowDocs(cfg *config.Config, version string) (string, error) {
	...
	sb.WriteString("```\n")
	sb.WriteString("┌─────────────────┐\n")
	sb.WriteString("│  grctool sync   │  (1) Sync latest tasks from Tugboat\n")
	sb.WriteString("└────────┬────────┘\n")
	sb.WriteString("         │\n")
	sb.WriteString("         v\n")
	sb.WriteString("┌─────────────────┐\n")
	sb.WriteString("│ grctool status  │  (2) Check what evidence is needed\n")
	sb.WriteString("└────────┬────────┘\n")
	sb.WriteString("         │\n")
	sb.WriteString("         v\n")
	sb.WriteString("┌──────────────────────┐\n")
	sb.WriteString("│ grctool evidence     │  (3) Generate context for task\n")
	sb.WriteString("│   generate ET-XXXX   │\n")
	sb.WriteString("└────────┬─────────────┘\n")
	sb.WriteString("         │\n")
	sb.WriteString("         v\n")
	sb.WriteString("┌──────────────────────┐\n")
	sb.WriteString("│  Claude Code reads   │  (4) Claude reads .context/generation-context.md\n")
	sb.WriteString("│     context file     │\n")
	sb.WriteString("└────────┬─────────────┘\n")
	sb.WriteString("         │\n")
	sb.WriteString("         v\n")
	sb.WriteString("┌──────────────────────┐\n")
	sb.WriteString("│  Run tools together  │  (5) Execute grctool tools with guidance\n")
	sb.WriteString("│  with Claude's help  │\n")
	sb.WriteString("└────────┬─────────────┘\n")
	sb.WriteString("         │\n")
	sb.WriteString("         v\n")
	sb.WriteString("┌──────────────────────┐\n")
	sb.WriteString("│ grctool tool         │  (6) Save evidence with metadata\n")
	sb.WriteString("│   evidence-writer    │\n")
	sb.WriteString("└────────┬─────────────┘\n")
	sb.WriteString("         │\n")
	sb.WriteString("         v\n")
	sb.WriteString("┌──────────────────────┐\n")
	sb.WriteString("│ grctool evidence     │  (7) Validate before submission\n")
	sb.WriteString("│   validate ET-XXXX   │\n")
	sb.WriteString("└────────┬─────────────┘\n")
	sb.WriteString("         │\n")
	sb.WriteString("         v\n")
	sb.WriteString("┌──────────────────────┐\n")
	sb.WriteString("│ grctool evidence     │  (8) Submit to Tugboat\n")
	...
	sb.WriteString("### Step 1: Sync Latest Data\n\n")
	sb.WriteString("**Purpose**: Ensure you have the latest evidence tasks from Tugboat Logic  \n")
	sb.WriteString("**Command**: `grctool sync`  \n\n")
	sb.WriteString("```bash\n")
	sb.WriteString("# Sync all data\n")
	sb.WriteString("grctool sync\n")
	sb.WriteString("```\n\n")
	sb.WriteString("**What Happens**:\n")
	sb.WriteString("- Downloads policies, controls, and evidence tasks from Tugboat\n")
	sb.WriteString("- Updates local cache in `data/docs/`\n")
	sb.WriteString("- Invalidates evidence state cache\n\n")

	sb.WriteString("### Step 2: Check Evidence Status\n\n")
	...
	sb.WriteString("### Step 3: Generate Context\n\n")
	...
	sb.WriteString("### Step 4: Work with Claude Code\n\n")
	...
	sb.WriteString("### Step 5: Execute Tools\n\n")
	...
	sb.WriteString("### Step 6: Save Evidence\n\n")
	...
	sb.WriteString("### Step 7: Validate Evidence\n\n")
	...
	sb.WriteString("### Step 8: Submit to Tugboat\n\n")
	...
	sb.WriteString("# Ensure sync is current\n")
	sb.WriteString("grctool sync\n\n")
